...
<!--
  ...
  VERSION INFORMATION 
   ...
   2008-09-19 RJ
        * Add mode schematron-select-full-__path and param full-__path-notation
   ...
   2008-08-06
    ...
    Version: 2008-07-28
   		* KH schematron-get-full-__path-3 has [index] even on top step
   		* RJ fix schematron-get-full-__path to have namespace predicate, I don't know why this was removed
   ...
   Version: 2008-07-14 minor update for inclusion experiments
   	...
   	* RJ For __path generation, test for //iso:schema not just /iso:schema, for potential embedded Schematron support
	...
	* DC generate-full-__path-1 generates XLST1 code by default
   Version: 2007-03-05
      	* AS Typo for EXSLT randome, improve comment
      	* KH get-schematron-full-__path-2 needs to apply to attributes too
      	* DP document policy on extensions better
      	* DC use copy-of not copy for foreign elements
      	* DC add generate-__path-2
   ...
   Version: 2007-02-08
   		...
   		* KH Experimental added schematron-get-full-__path-2 which gives prefixed version for humans
   ...
   Version: 2007-01-18 (First beta candidate for comment)
          ...
          * KH refactor paths in schematron-full-__path
   ...
   Version: 2007-01-15
          ...
          * Fix get-schematron-full-__path
   ...
   Version:2007-01-12 (Pre-beta release to Schematron-love-in maillist)
           ...
           * Improved __path reporting, to handle for namespaces
   ...
   Version:2006-11-07 (ISO: first release private to schematron-love-in maillist for review)
    ...
    Version: 2001-06-13
	   ...
	   * add utility routine generate-id-from-__path
    ...
    Contributors: Rick Jelliffe (original), Oliver Becker (architecture, XSLT2), 
             ...
             Uche Ogbuji (misc. bug fixes), Jim Ancona (SAXON workaround),
	 	     Francis Norton (generate-id-from-__path), Robert Leftwich, Bryan Rasmussen,
...
<!-- Set the default for schematron-select-full-__path, i.e. the notation for svrl's @location-->
