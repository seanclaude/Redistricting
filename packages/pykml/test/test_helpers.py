...
from packages.pykml.parser import fromstring
...
class KmlHelpersTestCase(unittest.TestCase):
    ...
    def test_separate_namespace(self):
        ...
        from packages.pykml.helpers import separate_namespace
    ...
    def test_set_max_decimal_places(self):
        ...
        from packages.pykml.helpers import set_max_decimal_places
