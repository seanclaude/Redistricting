...
from packages.pykml.parser import Schema
from packages.pykml.factory import KML_ElementMaker as KML
from packages.pykml.factory import ATOM_ElementMaker as ATOM
...
class KmlFactoryTestCase(unittest.TestCase):
    ...
    def test_get_factory_object_name(self):
        ...
        from packages.pykml.factory import get_factory_object_name
...
class GeneratePythonScriptTestCase(unittest.TestCase):
    ...
    def test_write_python_script_for_kml_document(self):
        """Tests the creation of a trivial OGC KML document."""
        from packages.pykml.factory import write_python_script_for_kml_document
    ...
    def test_write_python_script_for_kml_document_with_cdata(self):
        ...
        import os
        import tempfile
        from packages.pykml.parser import parse
        from packages.pykml.factory import write_python_script_for_kml_document
